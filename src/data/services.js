export const servicesData = [
  {
    ...
    commonIssues: ["Excessive vibration", "Drainage failure", "Cycle interruptions", "Electronic error codes"],
    image: "/service-1.jpg",
  ...
  },
  {
    ...
    commonIssues: ["Insufficient cooling", "Abnormal compressor noise", "Ice buildup", "Water dispenser leaks"],
    image: "/service-2.jpg",
    slug: "refrigerator"
  },
  {
    ...
    commonIssues: ["Cloudy glassware", "Poor drainage", "Cleaning cycle failure", "Internal leakage"],
    image: "/service-3.jpg",
    slug: "dishwasher"
  },
  {
    ...
    commonIssues: ["Backlight failure", "HDMI port damage", "Sound distortion", "Power supply issues"],
    image: "/service-4.jpg",
    slug: "television"
  },
  {
    ...
    commonIssues: ["Heating element failure", "Pump blockages", "Seal degradation", "Technical calibration"],
    image: "/service-5.jpg",
    slug: "coffee-maker"
  },
  {
    ...
    commonIssues: ["Gas leakage", "PCB failure", "Blower motor issues", "Inadequate cooling"],
    image: "/service-7.jpg",
  ...
  },
  {
    ...
    commonIssues: ["Magnetron failure", "Turntable issues", "Touch panel unresponsive", "Sparking internally"],
    image: "/service-8.jpg",
    slug: "microwave-oven"
  },
  {
    ...
    commonIssues: ["Ignition failure", "Uneven heating", "Gas leak detection", "Thermostat inaccuracies"],
    image: "/service-9.jpg",
    slug: "oven-stove"
  },
  {
    ...
    commonIssues: ["Filter saturation", "Pump malfunction", "TDS imbalance", "Water taste issues"],
  ...
  },
  {
    ...
    commonIssues: ["No heat", "Drum not spinning", "Excessive noise", "Overheating issues"],
  ...
  },
  {
    ...
    commonIssues: ["Suction power loss", "Loud motor noise", "Switch panel failure", "Vibration issues"],
  ...
  },
  {
    ...
    commonIssues: ["Power connectivity", "Electronic failures", "Mechanical wear", "Performance loss"],
    image: "/service-6.jpg",
